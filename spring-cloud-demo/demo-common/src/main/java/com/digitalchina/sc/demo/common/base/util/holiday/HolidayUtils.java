...
import com.digitalchina.sc.demo.common.base.util.DateUtil;
import com.digitalchina.sc.demo.common.base.util.holiday.presence.YearMap;
 ...
 * 工作日算法
 * <p>
 * https://github.com/iceenongli/iceworkday
 * <p>
 *
 * @author Hope Chen
 * @version 1.0
...
public class HolidayUtils {
    ...
    public static Map<String, Boolean> weekendMap(String year) {
        ...
        if (yearNum < 2001) {
            ...
            return YearMap.yearMap(yearNum);
        }
    }
    ...
    public static boolean isHoliday(Date date) {
        ...
        Boolean isWeekend = weekendMap.get(DateUtil.format(date, DatePattern.PURE_DATE_PATTERN));
        if (isWeekend == null) {
    ...
    private static Map<String, Boolean> complexMap(int yearNum, int dateAutumnNum, int dayAutumn) {
        Holiday[][] table = getAutumnTable(dateAutumnNum);
        Holiday[] row = getRow(table, dateAutumnNum, dayAutumn);
        return row2map(row, yearNum);
    }

    private static Map<String, Boolean> row2map(Holiday[] row, int yearNum) {
        Map<String, Boolean> map = new HashMap<>();
     ...
     * @return
     */
    private static Holiday[] getRow(Holiday[][] table, int dateAutumnNum, int dayAutumn) {
        // 25 1 [0]
        // 25 2 [1]
        // 25 3 [2]
    ...
    private static Holiday[][] getAutumnTable(int dateAutumnNum) {
        Holiday[][] days1 = {
                {new Holiday(25, true), new Holiday(30, false), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true),
                        new Holiday(5, true), new Holiday(6, true), new Holiday(8, false)},
                {new Holiday(22, false), new Holiday(24, true), new Holiday(25, true), new Holiday(29, false), new Holiday(30, false),
                        new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true)},
                {new Holiday(25, true), new Holiday(26, true), new Holiday(27, true), new Holiday(28, false), new Holiday(29, false),
                        new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true), new Holiday(7, true),
                        new Holiday(12, false)},
                {new Holiday(21, false), new Holiday(25, true), new Holiday(26, true), new Holiday(28, false), new Holiday(1, true),
                        new Holiday(2, true), new Holiday(3, true), new Holiday(6, true), new Holiday(7, true),
                        new Holiday(11, false)},
                {new Holiday(20, false), new Holiday(25, true), new Holiday(1, true), new Holiday(2, true), new Holiday(5, true),
                        new Holiday(6, true), new Holiday(7, true), new Holiday(10, false)},
                {new Holiday(27, true), new Holiday(1, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(7, true), new Holiday(9, false), new Holiday(10, false)},
                {new Holiday(26, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(7, true), new Holiday(8, false), new Holiday(9, false)}};
        Holiday[][] days2 = {
                {new Holiday(23, false), new Holiday(25, true), new Holiday(26, true), new Holiday(30, false), new Holiday(2, true),
                        new Holiday(3, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(8, false)},
                {new Holiday(23, false), new Holiday(26, true), new Holiday(27, true), new Holiday(28, true), new Holiday(29, false),
                        new Holiday(30, false), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true),
                        new Holiday(5, true), new Holiday(13, false)},
                {new Holiday(22, false), new Holiday(26, true), new Holiday(27, true), new Holiday(29, false), new Holiday(1, true),
                        new Holiday(2, true), new Holiday(3, true), new Holiday(4, true), new Holiday(7, true)},
                {new Holiday(21, false), new Holiday(26, true), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true),
                        new Holiday(6, true), new Holiday(7, true)},
                {new Holiday(1, true), new Holiday(2, true), new Holiday(5, true), new Holiday(6, true), new Holiday(7, true),
                        new Holiday(10, false)},
                {new Holiday(1, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true), new Holiday(7, true),
                        new Holiday(9, false)},
                {new Holiday(26, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(7, true), new Holiday(8, false), new Holiday(9, false)}};
        Holiday[][] days3 = {
                {new Holiday(23, false), new Holiday(24, false), new Holiday(25, true), new Holiday(26, true), new Holiday(27, true),
                        new Holiday(30, false), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true),
                        new Holiday(6, true), new Holiday(8, false)},
                {new Holiday(27, true), new Holiday(28, true), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true),
                        new Holiday(4, true), new Holiday(6, false), new Holiday(7, false)},
                {new Holiday(27, true), new Holiday(30, true), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true),
                        new Holiday(4, true), new Holiday(5, false), new Holiday(6, false)},
                {new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(6, true), new Holiday(7, true),
                        new Holiday(11, false)},
                {new Holiday(1, true), new Holiday(2, true), new Holiday(5, true), new Holiday(6, true), new Holiday(7, true),
                        new Holiday(10, false)},
                {new Holiday(27, true), new Holiday(1, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(7, true), new Holiday(9, false), new Holiday(10, false)},
                {new Holiday(24, false), new Holiday(26, true), new Holiday(27, true), new Holiday(3, true), new Holiday(4, true),
                        new Holiday(5, true), new Holiday(6, true), new Holiday(7, true), new Holiday(8, false),
                        new Holiday(9, false)}};
        Holiday[][] days4 = {
                {new Holiday(28, true), new Holiday(29, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true),
                        new Holiday(5, true), new Holiday(7, false), new Holiday(8, false)},
                {new Holiday(28, true), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true),
                        new Holiday(5, true), new Holiday(6, false), new Holiday(7, false)},
                {new Holiday(30, true), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true),
                        new Holiday(6, false)},
                {new Holiday(27, false), new Holiday(29, true), new Holiday(30, true), new Holiday(1, true), new Holiday(2, true),
                        new Holiday(3, true)},
                {new Holiday(26, false), new Holiday(27, false), new Holiday(28, true), new Holiday(29, true), new Holiday(30, true),
                        new Holiday(1, true), new Holiday(2, true), new Holiday(5, true)},
                {new Holiday(25, false), new Holiday(26, false), new Holiday(28, true), new Holiday(29, true), new Holiday(30, true),
                        new Holiday(1, true), new Holiday(4, true), new Holiday(5, true)},
                {new Holiday(25, false), new Holiday(28, true), new Holiday(29, true), new Holiday(30, true), new Holiday(3, true),
                        new Holiday(4, true), new Holiday(5, true), new Holiday(8, false)}};
        Holiday[][] days5 = {
                {new Holiday(29, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true),
                        new Holiday(6, true), new Holiday(7, false), new Holiday(8, false)},
                {new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true),
                        new Holiday(7, false)},
                {new Holiday(28, false), new Holiday(30, true), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true),
                        new Holiday(4, true)},
                {new Holiday(27, false), new Holiday(28, false), new Holiday(29, true), new Holiday(30, true), new Holiday(1, true),
                        new Holiday(2, true), new Holiday(3, true), new Holiday(6, true)},
                {new Holiday(26, false), new Holiday(27, false), new Holiday(29, true), new Holiday(30, true), new Holiday(1, true),
                        new Holiday(2, true), new Holiday(5, true), new Holiday(6, true)},
                {new Holiday(26, false), new Holiday(29, true), new Holiday(30, true), new Holiday(1, true), new Holiday(4, true),
                        new Holiday(5, true), new Holiday(6, true), new Holiday(9, false)},
                {new Holiday(29, true), new Holiday(30, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true),
                        new Holiday(6, true), new Holiday(8, false), new Holiday(9, false)}};
        Holiday[][] days6 = {
                {new Holiday(2, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(8, false)},
                {new Holiday(29, false), new Holiday(1, true), new Holiday(2, true), new Holiday(3, true), new Holiday(4, true),
                        new Holiday(5, true)},
                {new Holiday(28, false), new Holiday(29, false), new Holiday(30, true), new Holiday(1, true), new Holiday(2, true),
                        new Holiday(3, true), new Holiday(4, true), new Holiday(7, true)},
                {new Holiday(27, false), new Holiday(28, false), new Holiday(30, true), new Holiday(1, true), new Holiday(2, true),
                        new Holiday(3, true), new Holiday(6, true), new Holiday(7, true)},
                {new Holiday(27, false), new Holiday(30, true), new Holiday(1, true), new Holiday(2, true), new Holiday(5, true),
                        new Holiday(6, true), new Holiday(7, true), new Holiday(10, false)},
                {new Holiday(30, true), new Holiday(1, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(7, true), new Holiday(9, false), new Holiday(10, false)},
                {new Holiday(30, true), new Holiday(3, true), new Holiday(4, true), new Holiday(5, true), new Holiday(6, true),
                        new Holiday(7, true), new Holiday(8, false), new Holiday(9, false)}};
        if (dateAutumnNum == 25) {
            return days1;
    ...
    private static String[] read(String fileName) {
        ...
        try {
            br = new BufferedReader(
                    new InputStreamReader(HolidayUtils.class.getClassLoader().getResourceAsStream(fileName)));
            String every = null;
    ...
    private static Map<String, Boolean> weekMapFromFile() {
        ...
        String[] lines = HolidayUtils.read(fileName);
